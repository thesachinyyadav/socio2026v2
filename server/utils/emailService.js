        ...
        <div style="background: white; padding: 40px 36px; border-radius: 0 0 16px 16px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.06);">
          ...
          <div style="background: linear-gradient(135deg, #fef3c7 0%, #fde68a 100%); border: 1px solid #f59e0b; border-radius: 10px; padding: 16px; margin: 0 0 24px 0;">
            <p style="color: #92400e; font-size: 13px; margin: 0; line-height: 1.5; text-align: center;">
              <strong>We're still building!</strong> Pardon any hiccups — your patience means everything to us.
            </p>
          </div>
...
---
We're still building! Pardon any hiccups — your patience means everything to us.
---
