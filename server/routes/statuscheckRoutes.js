...
const ROUTE_GROUP_COVERAGE = [
  ...
  { group: "clubs", mount: "/api/clubs", probe: "n/a (Supabase direct — no REST list endpoint)" },
  ...
  { group: "analytics", mount: "/api/analytics", probe: "/api/analytics/overview (masteradmin)" },
  { group: "hod-analytics", mount: "/api/hod-analytics", probe: "/api/hod-analytics/overview (hod)" },
  { group: "dean-analytics", mount: "/api/dean-analytics", probe: "/api/dean-analytics/summary (dean)" },
  { group: "volunteer", mount: "/api/volunteer", probe: "/api/volunteer/events" },
];
...
router.post("/run", async (req, res) => {
  ...
  const endpointChecks = await Promise.all([
    ...
    probeEndpoint(req, apiBaseUrl, { name: "Clubs endpoint", path: "/api/clubs?page=1&pageSize=5", method: "GET", expectedStatuses: [200, 404] }),
    ...
    probeEndpoint(req, apiBaseUrl, { name: "Venues (campuses list)", path: "/api/venues/campuses", method: "GET", expectedStatuses: [200] }),
    probeEndpoint(req, apiBaseUrl, { name: "Analytics overview", path: "/api/analytics/overview", method: "GET", expectedStatuses: [200, 403] }),
    probeEndpoint(req, apiBaseUrl, { name: "HOD Analytics overview", path: "/api/hod-analytics/overview", method: "GET", expectedStatuses: [200, 403, 400] }),
...
router.post("/stream-run", async (req, res) => {
  ...
  const endpointProbeConfigs = [
    ...
    { name: "Clubs endpoint", path: "/api/clubs?page=1&pageSize=5", method: "GET", expectedStatuses: [200, 404] },
    ...
    { name: "Venues (campuses list)", path: "/api/venues/campuses", method: "GET", expectedStatuses: [200] },
    { name: "Analytics overview", path: "/api/analytics/overview", method: "GET", expectedStatuses: [200, 403] },
    { name: "HOD Analytics overview", path: "/api/hod-analytics/overview", method: "GET", expectedStatuses: [200, 403, 400] },
