  ...
  const checks = [
    {
      ...
      key: "hod",
      method: "POST",
      route: `/api/events/${encodeURIComponent(TEST_IDS.eventHodDean)}/hod-dean-action`,
    ...
    },
    {
      ...
      key: "cfo",
      method: "POST",
      route: `/api/events/${encodeURIComponent(TEST_IDS.eventCfo)}/cfo-action`,
    ...
    },
    {
      ...
      key: "accounts",
      method: "POST",
      route: `/api/events/${encodeURIComponent(TEST_IDS.eventAccounts)}/accounts-action`,
      body: { action: "approved", notes: "Approved in automated smoke test path." },
      expect: [200],
    },
    {
      ...
      key: "hod",
      method: "POST",
      route: `/api/fests/${encodeURIComponent(TEST_IDS.festHod)}/hod-action`,
      body: { action: "approved", notes: "Approved in automated smoke test path." },
      expect: [200],
    },
    {
      ...
      key: "dean",
      method: "POST",
      route: `/api/fests/${encodeURIComponent(TEST_IDS.festDean)}/dean-action`,
      body: { action: "approved", notes: "Approved in automated smoke test path." },
      expect: [200],
    },
    {
      ...
      key: "cfo",
      method: "POST",
      route: `/api/fests/${encodeURIComponent(TEST_IDS.festCfo)}/cfo-action`,
      body: { action: "approved", notes: "Approved in automated smoke test path." },
      expect: [200],
    },
    {
      ...
      key: "accounts",
      method: "POST",
      route: `/api/fests/${encodeURIComponent(TEST_IDS.festAccounts)}/accounts-action`,
      body: { action: "approved", notes: "Approved in automated smoke test path." },
      expect: [200],
    },
    {
      ...
      key: "organizer",
      method: "GET",
      route: `/api/events/${encodeURIComponent(TEST_IDS.eventHodDean)}/context`,
      body: null,
      expect: [200],
    },
  ];
