...
export default function EventForm({
  ...
  const standaloneFlowIsFinalStep = standaloneFlowStep === "approvals";
  const standaloneStepHeading = !showStandaloneFlowStepper
    ? "Event details"
    : standaloneFlowStep === "details"
    ? "Event details"
    : standaloneFlowStep === "budget"
    ? "Budget page"
    : "Approvals page";
              ...
              {showStandaloneFlowStepper && (
                <div className="mb-6 sm:mb-8 rounded-xl border border-blue-100 bg-blue-50/70 p-4 sm:p-5">
                  ...
                  <p className="mt-3 text-xs text-blue-700">
                    Complete budget and approvals before final publish.
                  </p>
                </div>
              )}
              <form
              ...
              >
                ...
                >
                  ...
                  {hasFestSelected ? (
                    ...
                    <p className="mt-3 text-xs sm:text-sm text-gray-700">
                      Standalone approvals are optional. CFO approval is controlled by the Budget page and appears as a fixed step when funding is required.
                    </p>
                  )}
                </div>
                )}
                ...
                {showStandaloneFlowStepper && standaloneFlowStep === "budget" && (
                  ...
                  >
                    ...
                    <input
                      id="provideClaims"
                      type="checkbox"
                      checked={Boolean(watchedProvideClaims)}
                      readOnly
                      className="sr-only"
                      aria-hidden="true"
                    />
                    ...
                    {Boolean(watchedProvideClaims) && (
                      <div className="mt-4 rounded-2xl border border-gray-200 bg-white p-4 sm:p-6">
                        <div className="mb-4 rounded-lg border border-amber-200 bg-amber-50 px-3 py-2 text-xs text-amber-800">
                          ...
                          <p className="mt-1">
                            Budget approval is enabled. This adds CFO and Accounts approval in workflow.
                          </p>
                          <p className="mt-1">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-3 mt-8 sm:mt-10 pt-6 border-t border-gray-200">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                    {showStandaloneFlowStepper && standaloneFlowStep !== "details" && (
                      ...
                      >
                        Back: {standaloneFlowStep === "approvals" ? "Budget" : "Details"}
                      </button>
                    )}
                    ...
                    {(!showStandaloneFlowStepper || standaloneFlowStep === "details") && onSubmitDraft && (
                      <button
                        ...
                        className="w-full sm:w-auto px-5 py-2.5 border border-gray-300 text-gray-700 bg-gray-100 text-sm font-medium rounded-md hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 transition-colors disabled:opacity-60 disabled:cursor-not-allowed cursor-pointer"
                      >
